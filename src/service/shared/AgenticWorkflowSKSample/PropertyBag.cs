/// <summary>
/// PropertyBag is a strongly-typed, serializable key-value store with type-safe get/set/add methods.
/// </summary>
using System;
...
namespace AgenticWorkflowSKSample
{
    /// <summary>
    /// Strongly-typed property bag for storing arbitrary key-value pairs.
    /// </summary>
    public class PropertyBag : IDictionary<string, object?>
    {
        ...
        /// <summary>
        /// Initializes an empty PropertyBag.
        /// </summary>
        public PropertyBag() => _dict = new();

        /// <summary>
        /// Initializes a PropertyBag with an existing dictionary.
        /// </summary>
        [JsonConstructor]
        public PropertyBag(Dictionary<string, object?> dict) => _dict = dict ?? new();
